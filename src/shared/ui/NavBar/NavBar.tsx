...
export const NavBar: FC<NavBarProps> = ({
  ...
  <nav data-testid="navbar" className={[s.navbar, className].filter(Boolean).join(' ')}>
    ...
    <div className={s.rightSection}>
      {isAuthenticated ? (
        <>
          {/* Only show "Try Artist Pro" link for non-premium users */}
          {!isPremium && (
            <Link href={ROUTES.ARTIST_PRO} className={s.tryProLink} data-testid="navbar-try-artist-pro">Try Artist Pro</Link>
          )}
          <Link href={ROUTES.ARTIST_STUDIO} className={s.navTextLink} data-testid="navbar-artist-studio-link">Artist Studio</Link>
          ...
          <div ref={moreRef} className={s.dropdownWrapper}>
            ...
            {moreOpen && (
              <div className={`${s.dropdown} ${s.moreDropdown}`} data-testid="navbar-more-dropdown-menu">
                ...
                <Link href={ROUTES.ARTIST_PRO} className={s.dropdownItem} onClick={() => setMoreOpen(false)} data-testid="navbar-more-artist-membership">Artist Membership</Link>
                <div className={s.dropdownDivider} />
