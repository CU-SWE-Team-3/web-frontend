      ...
      <main className="max-w-[1240px] mx-auto px-6 py-10 flex gap-10">
        ...
        <section className="flex-1 min-w-0">
          <div className="mb-12">
            ...
            <div className="mb-12">
              <h3 className="text-[18px] font-bold text-white mb-4">Featured Charts</h3>
            ...
            {!isLoading && buckets.length > 0 ? (
              <div>
                <h3 className="text-[18px] font-bold text-white mb-4">Trending Playlists</h3>
                <div className="flex flex-wrap gap-5">
                  {buckets.map(b => (
                    <div 
                      key={b.id} 
              ...
              <div className="text-[#555] italic text-sm mt-10">
                No editorial content available at the moment.
              </div>
            )}
          </div>
        </section>
